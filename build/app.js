...
/***/ function(module, exports, __webpack_require__) {
	...
	var _StatsBar = __webpack_require__(181);
	    ...
	    _createClass(Game, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_StatsBar2.default, { player: this.game.player, floor: this.game.floor, gameOver: this.game.gameOver, newGame: this.newGame.bind(this) }),
	                _react2.default.createElement(_Map2.default, { gameMap: this.game.gameMap, playerPosition: this.game.playerPos, fogActive: this.state.fogActive, handleMove: this.game.handleMove.bind(this.game), forceUpdate: this.forceUpdate.bind(this) }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'text-xs-center m-t-2' },
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'btn btn-primary m-r-1', onClick: this.newGame.bind(this) },
	                        'Restart'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { className: 'btn btn-info', onClick: this.toggleFog.bind(this) },
	                        'Toggle fog'
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gameConfig = __webpack_require__(170);
	...
	var _creature = __webpack_require__(172);

	var _creature2 = _interopRequireDefault(_creature);

	var _gameMap = __webpack_require__(173);

	var _gameMap2 = _interopRequireDefault(_gameMap);

	var _mapGenerator = __webpack_require__(177);
	...
	var Game = function () {
	    // false - not over, 1 - player won, 2 - player lost
	    ...
	    function Game() {
	        ...
	        this.gameMap = new _gameMap2.default();
	        this.floor = 1;
	        this.playerPos = {
	            x: 1,
	            y: 1
	        };
	        this.player = new _player2.default(_gameConfig2.default.playerBaseStats);
	    ...
	    _createClass(Game, [{
	        ...
	        value: function generateMap() {
	            var mapGenerator = new _mapGenerator2.default(this.gameMap);
	            ...
	            if (this.floor < _gameConfig2.default.floorLimit) mapGenerator.addTrapdoor();

	            this.playerPos = _mapGenerator2.default.getCenter(mapGenerator.rooms[0]);
	        }
	    }, {
	        key: 'movePlayer',
	        value: function movePlayer(prevPos, nextPos) {
	            var prevX = prevPos.x;
	            var prevY = prevPos.y;
	            var nextX = nextPos.x;
	            var nextY = nextPos.y;
	            ...
	            var prevTile = this.gameMap.getTile(prevPos),
	                nextTile = this.gameMap.getTile(nextPos);

	            if (!_player2.default.isPlayer(prevTile.content)) throw 'Tried to move a non-player tile';

	            if (!prevTile.content.isAlive()) throw 'Tried to move a dead player';

	            if (!this.gameMap.isValidDestination(nextPos)) return false;

	            var shouldMove = true;
	            if (nextTile.type === _types2.default.CREATURE) {
	                ...
	                if (this.floor == _gameConfig2.default.floorLimit && this.gameMap.enemiesLeft === 0) {
	                    // TODO: game ovew - player won
	                    this.gameOver = 1;
	                    return false;
	                }
	            } else if (nextTile.type === _types2.default.GOLD) this.player.addGold(nextTile.content);else if (nextTile.type === _types2.default.TRAPDOOR) {
	                this.floor++;
	                this.gameMap = new _gameMap2.default();
	                ...
	                this.gameMap.insertPlayer({ x: this.playerPos.x, y: this.playerPos.y, player: this.player });
	                shouldMove = false;
	            } else if (nextTile.type === _types2.default.WEAPON) this.player.setWeapon(nextTile.content);else if (nextTile.type === _types2.default.HEALTH_POTION) this.player.heal(nextTile.content);
	        ...
	        key: 'battle',
	        value: function battle(enemy) {
	            if (!_creature2.default.isCreature(enemy)) throw 'Tile was of type CREATURE, but the content was not instance of Creature class';
	            ...
	            if (enemy.isAlive()) {
	                ...
	                this.player.addExperience(this.floor * _gameConfig2.default.experiencePerFloorMultiplier);
	        ...
	        value: function handleMove(direction) {
	            ...
	            var newPosition = Object.create(this.playerPos);
	            if (direction === 0) newPosition.x--;else if (direction === 1) newPosition.y--;else if (direction === 2) newPosition.x++;else if (direction === 3) newPosition.y++;

	            if (this.gameMap.isValidDestination(newPosition)) this.movePlayer(this.playerPos, newPosition);
	        }
	    }]);
...
/***/ function(module, exports) {
	...
	var Creature = function () {
	    function Creature(_ref) {
	        ...
	        var _ref$maxHealth = _ref.maxHealth;
	        var maxHealth = _ref$maxHealth === undefined ? health : _ref$maxHealth;
	    ...
	    _createClass(Creature, [{
	        ...
	        value: function attack(enemy) {
	            if (!Creature.isCreature(enemy)) throw 'Enemy is not a creature';

	            if (!enemy.isAlive()) throw 'Enemy is already dead';
	        ...
	        value: function heal(amount) {
	            ...
	            if (!amount) throw 'Amount of health to be restored was not a number';
	        ...
	        key: 'setAttackValue',
	        value: function setAttackValue(value) {
	            value = Number(value);
	            if (!value) throw 'New attack value to be set was not a number';

	            this.attackValue = value;
	        }
	    }], [{
	        key: 'isCreature',
	        value: function isCreature(creature) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameMap = function () {
	    function GameMap() {
	        ...
	        this.width = _gameConfig2.default.map.width;
	        this.height = _gameConfig2.default.map.height;
	        this.map = [];
	        this.enemiesLeft = 0;
	        ...
	        for (var x = 0; x < this.width; x++) {
	            ...
	            for (var y = 0; y < this.height; y++) {
	                this.map[x].push(new _tile2.default({ x: x, y: y }));
	            } // add an empty tile at this.map[x][y]
	        }
	    }
	    ...
	    _createClass(GameMap, [{
	        ...
	        value: function getTile(_ref) {
	            ...
	            if (!this.isValidPosition({ x: x, y: y })) return undefined;

	            return this.map[x][y];
	        }
	    }, {
	        key: 'isValidPosition',
	        value: function isValidPosition(_ref2) {
	            var x = _ref2.x;
	            var y = _ref2.y;
	        ...
	        value: function isValidDestination(_ref3) {
	            var x = _ref3.x;
	            var y = _ref3.y;

	            var tile = this.getTile({ x: x, y: y });
	            if (tile.type === _types2.default.WALL || !this.isValidPosition({ x: x, y: y })) return false;

	            return true;
	        }
	    }, {
	        key: 'insertCreature',
	        value: function insertCreature(_ref4) {
	            var x = _ref4.x;
	            var y = _ref4.y;
	            var creature = _ref4.creature;

	            if (!_creature2.default.isCreature(creature)) throw 'Entity to be inserted was not a creature';

	            if (!this.isValidDestination({ x: x, y: y })) throw 'Tried to insert a creature at an invalid destination';

	            var tile = this.getTile({ x: x, y: y });
	            tile.setType(_types2.default.CREATURE);
	        ...
	        key: 'insertWeapon',
	        value: function insertWeapon(_ref5) {
	            var x = _ref5.x;
	            var y = _ref5.y;
	            var weapon = _ref5.weapon;

	            weapon.attackValue = Number(weapon.attackValue);

	            if (!weapon.attackValue) throw 'Weapon\'s attack value is not a number';

	            if (!weapon.name) throw 'Weapon does not have a name';

	            if (!this.isValidDestination({ x: x, y: y })) throw 'Tried to insert a weapon at an invalid destination';

	            var tile = this.getTile({ x: x, y: y });
	            tile.setType(_types2.default.WEAPON);
	            tile.setContent(weapon);
	        }
	    }, {
	        key: 'insertGold',
	        value: function insertGold(_ref6) {
	            var x = _ref6.x;
	            var y = _ref6.y;
	            ...
	            if (!amount) throw 'Amount of gold to be inserted is not a number';

	            if (!this.isValidDestination({ x: x, y: y })) throw 'Tried to insert gold at an invalid destination';

	            var tile = this.getTile({ x: x, y: y });
	            tile.setType(_types2.default.GOLD);
	            tile.setContent(amount);
	        }
	    }, {
	        key: 'insertPlayer',
	        value: function insertPlayer(_ref7) {
	            var x = _ref7.x;
	            var y = _ref7.y;
	            var player = _ref7.player;

	            if (!_player2.default.isPlayer(player)) throw 'Entity to be inserted was not a player';

	            if (!this.isValidDestination({ x: x, y: y })) throw 'Tried to insert a player at an invalid destination';

	            var tile = this.getTile({ x: x, y: y });
	            tile.setType(_types2.default.PLAYER);
	            tile.setContent(player);
	        }
	    }, {
	        key: 'insertHealthPotion',
	        value: function insertHealthPotion(_ref8) {
	            var x = _ref8.x;
	            var y = _ref8.y;
	            var healAmount = _ref8.healAmount;

	            healAmount = Number(healAmount);
	            if (!healAmount) throw 'Heal amount is not a number';

	            if (!this.isValidDestination({ x: x, y: y })) throw 'Tried to insert a health potion at an invalid destination';

	            var tile = this.getTile({ x: x, y: y });
	            tile.setType(_types2.default.HEALTH_POTION);
	            tile.setContent(healAmount);
	        }
	    }, {
	        key: 'insertTrapdoor',
	        value: function insertTrapdoor(pos) {
	            if (!this.isValidDestination(pos)) throw 'Tried to insert a trapdoor at an invalid destination';

	            var tile = this.getTile(pos);
	            tile.setType(_types2.default.TRAPDOOR);
	            tile.setContent(null);
	        }
	    }, {
	        key: 'clearTile',
	        value: function clearTile(_ref9) {
	            var x = _ref9.x;
	            var y = _ref9.y;

	            if (!this.isValidPosition({ x: x, y: y })) throw 'Position to be cleared was invalid';

	            this.getTile({ x: x, y: y }).clear();
	        }
	    }, {
	        key: 'emptyArea',
	        value: function emptyArea(area) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = function (_Creature) {
	    ...
	    function Player(_ref) {
	        ...
	        var _ref$weapon = _ref.weapon;
	        var weapon = _ref$weapon === undefined ? _gameConfig2.default.startingWeapon : _ref$weapon;
	        var experience = _ref.experience;

	        _classCallCheck(this, Player);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Player).call(this, { health: health }));

	        _this.experience = experience;
	        _this.gold = gold;
	        _this.level = level;
	        _this.experienceNeeded = _this.level * _gameConfig2.default.experiencePerLevelMultiplier;
	        _this.setWeapon(weapon);
	        return _this;
	    }

	    _createClass(Player, [{
	        key: 'addExperience',
	        value: function addExperience(amount) {
	            amount = Number(amount);
	            if (!amount) throw 'Amount of experience to be added was not a number';

	            this.experience += amount;

	            var expNeeded = this.experienceNeeded;
	            if (this.experience >= expNeeded) {
	                this.level++;
	                this.experience -= expNeeded;
	                this.experience += _gameConfig2.default.experiencePerLevelMultiplier;

	                _get(Object.getPrototypeOf(Player.prototype), 'heal', this).call(this, Math.ceil(this.maxHealth / 2));
	            }
	        }
	    }, {
	        key: 'setWeapon',
	        value: function setWeapon(weapon) {
	            ...
	            if (!weapon.attackValue) throw 'Weapon\'s attack value was not a number';
	            if (!weapon.name) throw 'Weapon did not have a name';

	            this.weapon = weapon;
	            _get(Object.getPrototypeOf(Player.prototype), 'setAttackValue', this).call(this, weapon.attackValue);
	        }
	    }, {
	        key: 'addGold',
	        value: function addGold(amount) {
	            amount = Number(amount);
	            if (!amount) throw 'Amount of gold to add was not a number';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = function () {
	    function Tile(_ref) {
	        ...
	        var type = _ref$type === undefined ? _types2.default.WALL : _ref$type;
	    ...
	    _createClass(Tile, [{
	        ...
	        value: function setType(newType) {
	            var found = false;
	            for (var currType in _types2.default) {
	                if (_types2.default[currType] === newType) {
	                    found = true;
	                    break;
	                }
	            }

	            if (found) this.type = newType;else throw 'Tile type to be set is invalid (was not found in the TYPE object)';
	        }
	    }, {
	        key: 'setContent',
	        value: function setContent(newContent) {
	            if (_player2.default.isPlayer(newContent)) {
	                if (this.type !== _types2.default.PLAYER) throw 'Tried to set content to a player but the type is wrong';
	            } else if (_creature2.default.isCreature(newContent)) {
	                if (this.type !== _types2.default.CREATURE) throw 'Tried to set content to a creature but the type is wrong';
	            } else if (newContent === null) {
	                if (this.type !== _types2.default.EMPTY && this.type !== _types2.default.WALL && this.type !== _types2.default.TRAPDOOR) throw 'Tried to set content to null but the type is wrong';
	            }
	        ...
	        value: function clear() {
	            this.setType(_types2.default.EMPTY);
	            this.setContent(null);
	        }
	    }, {
	        key: 'isEmpty',
	        value: function isEmpty() {
	            return this.type === _types2.default.EMPTY;
	        }
	    }, {
	        key: 'color',
	        get: function get() {
	            return _colors2.default.get(this.type);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	colors.set(_types2.default.WALL, 'black');
	colors.set(_types2.default.EMPTY, 'white');
	colors.set(_types2.default.PLAYER, 'green');
	colors.set(_types2.default.CREATURE, 'red');
	colors.set(_types2.default.WEAPON, 'blue');
	colors.set(_types2.default.GOLD, 'gold');
	colors.set(_types2.default.TRAPDOOR, 'grey');
	colors.set(_types2.default.HEALTH_POTION, 'pink');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _helperFunctions = __webpack_require__(178);
	...
	var MapGenerator = function () {
	    function MapGenerator(map) {
	        ...
	        if (!map instanceof _gameMap2.default) throw 'Map passed to a map generator was not an instance of GameMap class';

	        this.map = map;
	        this.rooms = [];
	        this.widthDifference = _gameConfig2.default.roomSize.maxWidth - _gameConfig2.default.roomSize.minWidth;
	        this.heightDifference = _gameConfig2.default.roomSize.maxHeight - _gameConfig2.default.roomSize.minHeight;
	    }

	    _createClass(MapGenerator, [{
	        key: 'makeRoom',
	        value: function makeRoom(room) {
	            var x = room.x;
	            var y = room.y;
	            var w = room.w;
	            var h = room.h;
	            ...
	            if (!this.map.isValidPosition({ x: x, y: y }) || !this.map.isValidPosition({ x: x + w, y: y + h })) throw 'Room corners are not valid positions on the map';

	            this.rooms.forEach(function (existingRoom) {
	                if (MapGenerator.doIntersect(existingRoom, room)) intersect = true;
	            });
	        ...
	        key: 'addTunnels',
	        value: function addTunnels() {
	            var _this = this;

	            this.rooms.reduce(function (previous, current) {
	                _this.makeTunnel(previous, current);
	                return current;
	            });
	        }
	    }, {
	        ...
	        value: function addRooms() {
	            for (var i = 0; i < _gameConfig2.default.roomsPerFloor; i++) {
	                this.makeRoom(this.randomRoomPosition());
	            }
	        }
	    }, {
	        key: 'addEnemies',
	        value: function addEnemies(floor) {
	            for (var i = 0; i < _gameConfig2.default.enemiesPerFloor; i++) {
	                this.makeEnemy(floor);
	            }
	        }
	    }, {
	        key: 'makeEnemy',
	        value: function makeEnemy(floor) {
	            var insertPosition = this.randomValidEmptyPosition(),
	                enemy = undefined;

	            enemy = new _creature2.default({
	                health: (0, _helperFunctions.randomizeStat)(floor * _gameConfig2.default.enemyHealthFloorMultiplier),
	                attack: (0, _helperFunctions.randomizeStat)(floor * _gameConfig2.default.enemyAttackValueFloorMultiplier)
	            });
	        ...
	        key: 'addHealthPotions',
	        value: function addHealthPotions(floor) {
	            for (var i = 0; i < _gameConfig2.default.healthPotionsPerFloor; i++) {
	                this.makeHealthPotion(floor);
	            }
	        }
	    }, {
	        key: 'makeHealthPotion',
	        value: function makeHealthPotion(floor) {
	            var insertPosition = this.randomValidEmptyPosition();

	            this.map.insertHealthPotion({
	                x: insertPosition.x,
	                y: insertPosition.y,
	                healAmount: (0, _helperFunctions.randomizeStat)(floor * _gameConfig2.default.healthPerPotionFloorMultiplier)
	            });
	        }
	    }, {
	        key: 'addWeapon',
	        value: function addWeapon(floor) {
	            var weapon = _gameConfig2.default.weapons[floor - 1],
	        ...
	        key: 'addTrapdoor',
	        value: function addTrapdoor() {
	            this.map.insertTrapdoor(this.randomValidEmptyPosition());
	        }
	    }, {
	        key: 'addGold',
	        value: function addGold(floor) {
	            for (var i = 0; i < _gameConfig2.default.goldPilesPerFloor; i++) {
	                this.makeGold(floor);
	            }
	        }
	    }, {
	        key: 'makeGold',
	        value: function makeGold(floor) {
	            var insertPosition = this.randomValidEmptyPosition();

	            this.map.insertGold({
	                x: insertPosition.x,
	                y: insertPosition.y,
	                amount: (0, _helperFunctions.randomizeStat)(floor * _gameConfig2.default.goldPerPileFloorMultiplier)
	            });
	        }
	    }, {
	        key: 'randomValidEmptyPosition',
	        value: function randomValidEmptyPosition() {
	        ...
	        key: 'randomRoomPosition',
	        value: function randomRoomPosition() {
	            var newRoom = {
	                x: 0,
	                y: 0,
	                w: _gameConfig2.default.roomSize.minWidth + MapGenerator.randomNumber(this.widthDifference),
	                h: _gameConfig2.default.roomSize.minHeight + MapGenerator.randomNumber(this.heightDifference)
	            };

	            newRoom.x = MapGenerator.randomNumber(_gameConfig2.default.map.width - newRoom.w);
	            newRoom.y = MapGenerator.randomNumber(_gameConfig2.default.map.height - newRoom.h);

	            for (var i = 0; i < this.rooms; i++) {
	                if (MapGenerator.doIntersect(this.rooms[i], newRoom)) return this.randomRoomPosition();
	            }
	        ...
	        key: 'makeTunnel',
	        value: function makeTunnel(room1, room2) {
	            var center1 = MapGenerator.getCenter(room1),
	        ...
	        key: 'makeHorizontalTunnel',
	        value: function makeHorizontalTunnel(fromX, toX, y) {
	            if (!this.map.isValidPosition({ x: fromX, y: y }) || !this.map.isValidPosition({ x: toX, y: y })) throw 'Tunnel cannot be created because positions are invalid';
	            ...
	            for (var x = fromX; x <= toX; x++) {
	                this.map.clearTile({ x: x, y: y });
	            }
	        }
	    }, {
	        key: 'makeVerticalTunnel',
	        value: function makeVerticalTunnel(x, fromY, toY) {
	            if (!this.map.isValidPosition({ x: x, y: fromY }) || !this.map.isValidPosition({ x: x, y: toY })) throw 'Tunnel cannot be created because positions are invalid';
	        ...
	        key: 'doIntersect',
	        value: function doIntersect(room1, room2) {
	            // TODO: improve this logic
	            return room1.x <= room2.x + room2.w && room1.x + room1.w >= room2.x && room1.y <= room2.y + room2.h && room1.y + room1.h >= room2.y;
	        }
	    }, {
	        key: 'getCenter',
	        ...
	        key: 'randomPosition',
	        value: function randomPosition(room) {
	            return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.randomizeStat = randomizeStat;
	...
	function randomizeStat(value) {
	    // value * (0.9 - 1.1) for randomVariance = 10
	    return Math.round(value * (100 - _gameConfig2.default.randomVariance + _mapGenerator2.default.randomNumber(_gameConfig2.default.randomVariance * 2)) / 100);
	}
	...
	var Map = function (_React$Component) {
	    ...
	    _createClass(Map, [{
	        ...
	        value: function getDisplayRows() {
	            var map = this.props.gameMap,
	                displayRows = [],
	                tileWidth = 100 / _gameConfig2.default.map.width + '%';

	            for (var y = 0; y < map.height; y++) {
	                var displayTiles = [];
	                for (var x = 0; x < map.width; x++) {
	                    displayTiles.push(_react2.default.createElement(_tile2.default, { x: x, y: y, key: x, color: this.checkColor({ x: x, y: y }), width: tileWidth }));
	                }
	                displayRows.push(_react2.default.createElement(
	                    'div',
	                    { key: y, className: 'game-map-row' },
	                    displayTiles
	                ));
	            }
	        ...
	        key: 'checkColor',
	        value: function checkColor(position) {
	            var color = this.props.gameMap.getTile(position).color;

	            if (this.props.fogActive && (0, _helperFunctions.getDistance)(this.props.playerPosition, position) > _gameConfig2.default.renderRadius) color = _gameConfig2.default.fogColor;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tile = function (_React$Component) {
	    ...
	    function Tile() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Tile).call(this));
	    }
	    ...
	    _createClass(Tile, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("div", { className: "game-map-tile", style: style });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StatsBar = function (_React$Component) {
	    _inherits(StatsBar, _React$Component);

	    function StatsBar() {
	        _classCallCheck(this, StatsBar);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(StatsBar).call(this));
	    }

	    _createClass(StatsBar, [{
	        key: 'render',
	        value: function render() {
	            var _props = this.props;
	            var player = _props.player;
	            var floor = _props.floor;
	            var gameOver = _props.gameOver;


	            if (gameOver) return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { onClick: this.props.newGame, className: 'btn btn-primary m-b-1' },
